...
DROP TABLE IF EXISTS faculty_phd_details CASCADE;
DROP TABLE IF EXISTS faculty_qualification_details CASCADE;
DROP TABLE IF EXISTS faculty_professional_details CASCADE;
...
CREATE TABLE faculty_professional_details (
  id SERIAL PRIMARY KEY,
...
CREATE TABLE faculty_qualification_details (
  id SERIAL PRIMARY KEY,
  faculty_id INTEGER REFERENCES faculty_profiles(id) ON DELETE CASCADE,
...
CREATE TABLE faculty_phd_details (
  id SERIAL PRIMARY KEY,
  faculty_id INTEGER REFERENCES faculty_profiles(id) ON DELETE CASCADE,
...
CREATE INDEX idx_faculty_profiles_email ON faculty_profiles(email);
CREATE INDEX idx_faculty_profiles_first_name ON faculty_profiles(first_name);
CREATE INDEX idx_faculty_profiles_last_name ON faculty_profiles(last_name);
CREATE INDEX idx_faculty_professional_details_faculty_id ON faculty_professional_details(faculty_id);
CREATE INDEX idx_faculty_professional_details_employee_no ON faculty_professional_details(employee_no);
CREATE INDEX idx_faculty_qualification_details_faculty_id ON faculty_qualification_details(faculty_id);
CREATE INDEX idx_faculty_phd_details_faculty_id ON faculty_phd_details(faculty_id);
